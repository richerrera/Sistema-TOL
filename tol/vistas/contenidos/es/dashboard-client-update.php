            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-4">
                        <div class="form-outline mb-4">
                            <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{4,29}" class="form-control" name="cliente_municipio_up" value="<?php echo $campos['cliente_municipio']; ?>" id="cliente_municipio" maxlength="29">
                            <label for="cliente_municipio" class="form-label">Municipio <?php echo FIELD_OBLIGATORY; ?></label>
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="form-outline mb-4">
                            <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{4,29}" class="form-control" name="cliente_departamento_up" value="<?php echo $campos['cliente_departamento']; ?>" id="cliente_departamento" maxlength="29">
