...
<div class="container-fluid">
    <ul class="nav nav-tabs nav-justified mb-4" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link active" href="<?php echo SERVERURL.DASHBOARD; ?>/producto-search/" ><i class="fas fa-search fa-fw"></i> &nbsp; Buscar productos</a>
        </li>
    </ul>
</div>
...
<div class="container-fluid">
    ...
    <div class="dashboard-container mb-4">
        ...
        <?php
            ...
            echo $ins_producto->paginador_producto_controlador($pagina[2],15,$pagina[1],$_SESSION['busqueda_producto']);
        ?>
    </div>
    <?php } ?>
</div>