                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="usuario_cargo_up" value="Usuario" id="usuario_cargo_usuario" <?php if($campos['usuario_cargo']=="Usuario"){ echo "checked"; } ?> />
                                <label class="form-check-label" for="usuario_cargo_usuario">Usuario</label>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
