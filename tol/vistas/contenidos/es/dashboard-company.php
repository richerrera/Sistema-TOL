...
<div class="container-fluid">
    ...
    <form class="dashboard-container FormularioAjax" method="POST" data-form="update" data-lang="<?php echo LANG; ?>" autocomplete="off" action="<?php echo SERVERURL;?>ajax/empresaAjax.php">
        ...
        <fieldset class="mb-4">
            <legend><i class="fas fa-money-check-alt"></i> &nbsp; Información Bancaria</legend>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-outline mb-4">
                            <input type="text" pattern="[0-9]{1,2}" class="form-control" name="empresa_cuenta_up" value="<?php echo $campos['empresa_cuenta']; ?>" id="empresa_cuenta" >
                            <label for="empresa_cuenta" class="form-label">No. de Cuenta Bancaria <?php echo FIELD_OBLIGATORY; ?></label>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-outline mb-4">
                            <input type="text" pattern="[a-zA-Z]{2,7}" class="form-control" name="empresa_banco_up" value="<?php echo $campos['empresa_banco']; ?>" id="empresa_banco" >
                            <label for="empresa_banco" class="form-label">Nombre de la Institución Bancaria<?php echo FIELD_OBLIGATORY; ?></label>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-outline mb-4">
                            <input type="text" pattern="[a-zA-Z]{2,7}" class="form-control" name="empresa_liquidación_up" value="<?php echo $campos['empresa_liquidacion']; ?>" id="empresa_liquidacion" maxlength="50">
                            <label for="empresa_liquidacion" class="form-label">Período de Liquidación<?php echo FIELD_OBLIGATORY; ?></label>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <label for="empresa_documento" class="form-label"> Documento Legal <?php echo FIELD_OBLIGATORY; ?></label>
                        <div class="form-outline mb-4">
