        ...
        <nav class="full-box nav-lateral-menu">
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo SERVERURL.DASHBOARD; ?>/producto-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; Agregar producto</a>
                        </li>
                        <li>
                            <a href="<?php echo SERVERURL.DASHBOARD; ?>/producto-list/"><i class="fas fa-boxes fa-fw"></i> &nbsp; Inventario de productos</a>
                        </li>
                        <li>
                            <a href="<?php echo SERVERURL.DASHBOARD; ?>/producto-search/"><i class="fas fa-search fa-fw"></i> &nbsp; Buscar producto</a>
                        </li>
                    </ul>
                </li>
